...
struct ShoppingPlanPickerView: View {

    @Bindable private var store: StoreOf<ShoppingPlanPickerFeature>

    init(store: StoreOf<ShoppingPlanPickerFeature>) {
        self.store = store
    }
...
private extension ShoppingPlanPickerView {
